  ...
  return (
    <div>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 w-14 h-14 rounded-full shadow-lg flex items-center justify-center text-2xl transition-all duration-300 hover:scale-110 z-40"
        style={{
        ...
        title={isChatSidebarOpen ? '關閉 AI 助手' : '打開 AI 助手'}
      >
        {isChatSidebarOpen ? '✕' : '💬'}
      </button>
      ...
      <div
        ...
        style={{
          ...
          background: '#181A20',
          boxShadow: isChatSidebarOpen ? '-4px 0 20px rgba(0, 0, 0, 0.5)' : 'none'
        }}
      >
        <div className="h-full flex flex-col">
          ...
          <div className="flex items-center justify-between p-4 border-b" style={{ borderColor: '#2B3139' }}>
            ...
            <button
              ...
              className="text-2xl hover:scale-110 transition-transform"
              style={{ color: '#848E9C', background: 'none', border: 'none', cursor: 'pointer' }}
            >
              ✕
            </button>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-3">
            {chatMessages.length === 0 ? (
              <div className="text-center py-16" style={{ color: '#848E9C' }}>
                <div className="text-6xl mb-4 opacity-30">💬</div>
                <div className="text-lg font-semibold mb-2" style={{ color: '#EAECEF' }}>歡迎使用 AI 助手</div>
                <div className="text-sm mb-4">向 AI 提問關於交易的任何問題</div>
                <div className="text-xs px-6">
                  <div className="mb-2" style={{ color: '#10B981' }}>💡 試試這些問題：</div>
          ...
          <div className="p-4 border-t" style={{ borderColor: '#2B3139' }}>
            <div className="flex gap-2">
              ...
              <button
                ...
                className="px-4 py-3 rounded-lg text-sm font-semibold transition-all duration-200 hover:scale-105 disabled:opacity-50 flex items-center gap-2"
                style={{
            ...
            <div className="text-xs mt-2 text-center" style={{ color: '#848E9C' }}>
              AI 可訪問完整交易數據 • 按 Enter 發送
            </div>
          </div>
        </div>
      </div>
      ...
      {isChatSidebarOpen && (
        <div
          ...
          onClick={() => setIsChatSidebarOpen(false)}
          style={{ opacity: isChatSidebarOpen ? 1 : 0 }}
        />
      )}
    </div>
  );
